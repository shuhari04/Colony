...
如果要把仓库作为正式对外展示页，建议仓库 About 文案使用这一句：

```text
A game-like 2.5D control plane for orchestrating local and remote AI agents across macOS, iPhone, and SSH worlds.
```

主题标签建议：

```text
ai-agents, multi-agent, orchestration, flutter, swift, macos, ios, ssh, tmux, codex
```
